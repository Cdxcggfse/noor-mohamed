...
import { ArrowUpRight, Download, Mail, Globe, MapPin, Phone, Send, CheckCircle2, Loader2 } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center space-y-12 sm:space-y-16">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          >
              ...
              {contactLinks.map((link) => {
                ...
                return (
                  <a
                    ...
                    className="group flex items-center gap-4 p-4 rounded-xl glass-panel glass-panel-hover border border-gold/15 transition-all duration-300"
                  >
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <a
                ...
                className="inline-flex items-center gap-2.5 px-6 py-3 rounded-full bg-gold text-ink font-mono text-xs font-semibold uppercase tracking-widest hover:bg-parchment transition-all duration-300 shadow-[0_0_20px_rgba(212,167,44,0.35)]"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2.5 px-6 py-3 rounded-full border border-gold/30 text-parchment font-mono text-xs font-medium uppercase tracking-widest hover:border-gold hover:text-gold transition-all duration-300 backdrop-blur-sm bg-plum/20"
              >
                Behance
          ...
          <motion.div
            ...
            className="lg:col-span-7 glass-panel rounded-2xl p-6 sm:p-10 border border-gold/20 shadow-[0_0_40px_rgba(212,167,44,0.1)] text-left"
          >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-plum/70 border border-gold/15 text-parchment placeholder-smoke/50 font-sans text-sm focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all"
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-plum/70 border border-gold/15 text-parchment placeholder-smoke/50 font-sans text-sm focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-4 rounded-xl bg-gold text-ink font-mono text-xs font-semibold uppercase tracking-widest hover:bg-parchment transition-all duration-300 shadow-[0_0_25px_rgba(212,167,44,0.35)] flex items-center justify-center gap-2 disabled:opacity-50"
                >
